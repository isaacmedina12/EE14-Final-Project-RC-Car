...
// the voltage to stabilize.  This is the first function called from adc_init();
// it should not need to be called directly from user code.
...
// Configure the ADC for a single reading on one channel.  Call adc_read() after
// this function to perform the read.  This is the simplest way to use the ADC,
...
EE14Lib_Err adc_config_single(const EE14Lib_Pin pin)
{
    ...
    ADC1->CFGR |= 0b00 << ADC_CFGR_RES_Pos; // Change to 0b11 for 6-bit resolution
